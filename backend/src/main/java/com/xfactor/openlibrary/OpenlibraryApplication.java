...
public class OpenlibraryApplication { // this is a SPRINGbootapplication class
	...
	public static void main(String[] args) {
		...
		Environment env = app.run(args).getEnvironment(); // these two line logs print "application is running!part
